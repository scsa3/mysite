...
import tools.views
from my_av.views import ActressList, FormSetView, MovieList
from . import views
...
urlpatterns = [
    ...
    path('tools/', tools.views.index, name='tools'),
    ...
    path('test/', views.my_test, name='temp'),

    path('actress/', ActressList.as_view()),
    path('videos/', MovieList.as_view()),
    path('form-set-view/', FormSetView.as_view()),
]
